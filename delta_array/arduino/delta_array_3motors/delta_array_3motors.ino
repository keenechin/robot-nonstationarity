...
Adafruit_DCMotor *MC1_M3 = MC1.getMotor(4);
Adafruit_DCMotor *MC1_M4 = MC1.getMotor(3);
...
Adafruit_DCMotor* motors[NUM_MOTORS] = {NULL, NULL, NULL, MC1_M1, MC1_M2, MC1_M3, MC1_M4, NULL, NULL, NULL, NULL, NULL};
...
int desired_motor_speeds[10][12]; //TODO
